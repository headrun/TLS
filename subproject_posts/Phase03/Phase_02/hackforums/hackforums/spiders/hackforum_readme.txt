...
hackforum_crawl.py  ---> collect all thread_url and store in hackforum_threads_crawl table
hackforum_posts.py        ---> collect all author_url and post_data and store in hackforums_authors_crawl,hellbound_posts tables
hackforum_author.py      ---> collect all the author data and store in hellbound_authors table
xpaths.py                 ---> contains all the xpaths for hackforum_crawler
utils.py               ---> some functions in my_utils file
configuration.py          ---> DB configurations

mysql> show tables;
+----------------------------+
| Tables_in_posts_hackforums |
+----------------------------+
| hackforum_authors          |
| hackforum_crawl            |
| hackforum_posts            |
...
CREATE DATABASE `posts_hackforums` /*!40100 DEFAULT CHARACTER SET latin1 */

CREATE TABLE `hackforum_status` (
...
CREATE TABLE `hackforum_authors` (
