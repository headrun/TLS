...
PUBLISHTIME = './/div[@class="message-main js-quickEditTarget"]//a[@class="message-attribution-main u-concealed"]//@data-time | .//div[@class="message-main js-quickEditTarget"]//div[not(contains(@class,"message-lastEdit"))]/@data-time'
