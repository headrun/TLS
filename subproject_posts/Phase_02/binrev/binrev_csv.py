...
def get_conn():
    ...
    conn = MySQLdb.connect(user="root", host = "localhost", db="binrev", passwd="hdrn59!", use_unicode=True, charset = 'utf8')
    cursor=conn.cursor()
    return conn,cursor
...
class Data():
    ...
    headers1 = ['username', 'domain', 'Crawl_Type','author_signature', 'join_date','lastactive','totalposts','FetchTime','Groups','reputation','credits','awards', 'rank','activetime', 'contact_info', 'reference_url']
