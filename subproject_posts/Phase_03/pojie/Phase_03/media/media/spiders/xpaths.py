...
AUTHOR = './/h3[@class="ipsType_sectionHead cAuthorPane_author ipsType_blendLinks ipsType_break"]//a[@class="ipsType_break"]/text() | .//h3[@class="ipsType_sectionHead cAuthorPane_author ipsType_blendLinks ipsType_break"]//strong/text() | .//span[@class="__cf_email__"]/@data-cfemail '
