#HACKTHISITE
hackthis_crawl.py  ---> collect all thread_url and store in hellbound_threads_crawl table
hackthis_thread.py        ---> collect all author_url and post_data and store in hellbound_authors_crawl,hellbound_posts tables
hackthis_author.py     ---> collect all the author data and store in hellbound_authors table
