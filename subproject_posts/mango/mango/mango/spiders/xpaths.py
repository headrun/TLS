...
AUTHOR_SIGNATURE = './/div[@class="baseHtml signature messageText ugc"]/text() | .//div[@class="baseHtml signature messageText ugc"]//a/@href | .//div[@class="baseHtml signature ugc"]//img[@class="mceSmilieSprite mceSmilie6"]/@src | .//div[@class="baseHtml signature messageText ugc"]//a/text() | .//div[@class="baseHtml signature ugc"]//img[@class="bbCodeImage"]/@src | .//div[@class="baseHtml signature ugc"]//span/text() | .//div[@class="baseHtml signature ugc"]//a//img[@class="bbCodeImage"]/@src | .//div[@class="baseHtml signature ugc"]//a[@class="externalLink"]//img[@class="bbCodeImage"]/@src'
