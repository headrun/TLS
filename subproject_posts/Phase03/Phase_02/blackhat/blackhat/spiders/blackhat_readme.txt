...
blackhat_crawl.py  ---> collect all thread_url and store in blackhat_threads_crawl table
blackhat_thread.py        ---> collect all author_url and post_data and storein blackhat_authors_crawl,blackhat_posts tables
blackhat_author.py     ---> collect all the author data and store in blackhat_authors table
xpaths.py                 ---> contains all the xpthas for blackhat_crawler
utils.py               ---> some functions in my_utils file
configuration.py          ---> DB configurations


CREATE DATABASE `posts_blackhat` /*!40100 DEFAULT CHARACTER SET latin1 */;

CREATE TABLE `blackhat_status` (
  `sk` varbinary(50) NOT NULL,
  `post_url` text COLLATE utf8_unicode_ci NOT NULL,
  `crawl_status` int(20) NOT NULL DEFAULT '0',
  `reference_url` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`sk`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE `blackhat_crawl` (
...
CREATE TABLE `blackhat_authors` (
  ...
  `active_time` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
CREATE TABLE `blackhat_posts` (
  ...
  `post_text` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
